    ...
    <div>
        ...
        <div class="ccontainer">
            <div class="left-content">
                <app-body style="justify-content: center; margin-top: 90px;">
                    <div class="app-header">
                        <div class="app-name">
                            <router-link to="/all">
                                <b style="color: #000;">全部商品</b>
                            </router-link>
                        </div>
                        <div class="container">
...
export default {
    ...
    mounted() {
        ...
        pubsub.subscribe({
            ...
            onMessage: () => {
                // 更新组件内部状态
                this.findIdleItem(this.userpage);
            },
        });
        pubsub.subscribe({
            channel: 'idle_add',
    ...
    methods: {
        findIdleItem(page) {
            ...
            if (this.labelName > 0) {
                this.$api.findAllIdleItemByLable({
