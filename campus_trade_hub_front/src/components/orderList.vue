<template>
    <div class="main-border">
        <el-table :data="Order" stripe style="width: 100%;color: #000;font-size: 18px">
            <el-table-column prop="orderNumber" label="订单号" show-overflow-tooltip width="250">
            </el-table-column>
            <el-table-column prop="idleItem.idleName" label="闲置物品名称" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="orderPrice" label="金额" show-overflow-tooltip min-width="100" width="150">
            </el-table-column>
            <el-table-column prop="createTime" label="创建时间" show-overflow-tooltip min-width="150" width="250">
            </el-table-column>
            ...
            <el-table-column prop="paymentWay" label="支付方式" width="100" show-overflow-tooltip>
            </el-table-column>
